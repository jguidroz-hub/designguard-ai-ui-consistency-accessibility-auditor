...
const FROM = process.env.EMAIL_FROM || 'DesignGuard: AI UI Consistency & Accessibility Auditor <noreply@example.com>';
const APP_NAME = 'DesignGuard: AI UI Consistency & Accessibility Auditor';
