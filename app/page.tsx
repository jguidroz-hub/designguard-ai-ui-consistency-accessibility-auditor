  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">DesignGuard: AI UI Consistency & Accessibility Auditor</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: For design system managers & front-end teams, automatically audits UI components against design guidelines & accessibility standards (WCAG). Ensures visual consistency & compliance across projects, saving significant design review time.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust DesignGuard: AI UI Consistency & Accessibility Auditor.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} DesignGuard: AI UI Consistency & Accessibility Auditor. All rights reserved.</p>
