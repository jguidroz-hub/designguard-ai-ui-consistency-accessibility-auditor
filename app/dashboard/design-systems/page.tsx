...
export default function DesignSystemsPage() {
  const [items, setItems] = useState<DesignSystemsItem[]>([]);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Design Systems Dashboard</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">Overview and management of tracked design systems</p>
