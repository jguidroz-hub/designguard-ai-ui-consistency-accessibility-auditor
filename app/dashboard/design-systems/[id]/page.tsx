...
interface DesignSystems/[id]Item {
  id: string;
  title?: string;
  status?: string;
  createdAt: string;
...
export default function DesignSystems/[id]Page() {
  const [items, setItems] = useState<DesignSystems/[id]Item[]>([]);
  ...
  const handleDelete = async (id: string) => {
    await fetch(`/api/design-systems/[id]/${id}`, { method: 'DELETE' });
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Design System Details</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">Detailed view of a specific design system</p>
